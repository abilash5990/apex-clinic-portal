...
export default function Footer({ setActiveTab, setShowSOS }: FooterProps) {
  return (
    <footer role="contentinfo" className="border-t border-gray-200 bg-white py-12 dark:border-gray-800 dark:bg-gray-950 transition-colors duration-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-8 border-b border-gray-150/80 dark:border-gray-850">
          ...
          <div className="md:col-span-4 space-y-3 text-xs">
            <h4 className="font-bold text-gray-900 dark:text-white uppercase tracking-wider font-mono text-[10.5px]">Suriya Health Group HQ</h4>
            <div className="space-y-2 text-gray-650 dark:text-gray-400">
              ...
              <p className="flex items-center"><Phone className="h-4 w-4 text-blue-500 mr-2 shrink-0" /> General Info: +1 (800) SURIYA-HELP</p>
              <p className="flex items-center"><Mail className="h-4 w-4 text-blue-500 mr-2 shrink-0" /> Inquiries: support@suriyahealth.com</p>
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 text-[10px] text-gray-400 gap-4">
          <p>© 2026 Suriya Health Systems Group. All rights reserved. HIPAA Protected Data Environment.</p>
